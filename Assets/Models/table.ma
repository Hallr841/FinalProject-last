...
//Name: table.ma
//Last modified: Sat, Dec 06, 2014 11:32:53 AM
//Codeset: UTF-8
requires maya "2015";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -4.6960376311905634 10.893613434003447 17.696864978546866 ;
	setAttr ".r" -type "double3" -24.338352728919673 2140.1999999996142 8.4510035341841613e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 24.408177458911659;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 2.8371429356568596 0.83440934068320893 -3.22734899526625 ;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" 0 2.2470764839312629 0 ;
	setAttr ".s" -type "double3" 6.3292882624018612 0.30219974912161773 7.0658087433379286 ;
...
createNode mesh -n "pCubeShape1" -p "transform6";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.84999999403953552 0.041666667908430099 ;
	...
	setAttr ".pt[43]" -type "float3" 0.0020335764 -6.5565109e-06 3.2751579e-15 ;
	setAttr ".pt[47]" -type "float3" 0.0021759868 6.4251944e-06 3.2751579e-15 ;
	setAttr ".pt[51]" -type "float3" 0.0021759868 6.4251944e-06 3.3306691e-15 ;
	setAttr ".pt[64]" -type "float3" 0.0020335615 -6.5565109e-06 3.3306691e-15 ;
	setAttr ".pt[68]" -type "float3" 0 1.1920929e-07 0 ;
createNode transform -n "pCylinder1";
	setAttr ".t" -type "double3" -2.9272936688202802 0.83440934068320871 3.2036846614583601 ;
	setAttr ".s" -type "double3" 0.10394178769313642 1.3585217273352839 0.14202775659536437 ;
...
createNode transform -n "pCylinder2";
	setAttr ".t" -type "double3" -2.9272936688202802 0.83440934068320871 -3.2357697102015814 ;
	setAttr ".s" -type "double3" 0.10394178769313642 1.3585217273352839 0.14202775659536437 ;
...
createNode transform -n "pCylinder3";
	setAttr ".t" -type "double3" 2.8371429480476862 0.83440934068320882 3.2036846614583605 ;
	setAttr ".s" -type "double3" 0.10394178769313642 1.3585217273352839 0.14202775659536437 ;
...
createNode transform -n "pCylinder4";
	setAttr ".t" -type "double3" 2.8371429480476862 0.83440934068320882 -3.2273489698697078 ;
	setAttr ".s" -type "double3" 0.10394178769313642 1.3585217273352839 0.14202775659536437 ;
...
createNode hyperView -n "hyperView1";
	setAttr ".vl" -type "double2" -259.52380952380958 -127.38095238095239 ;
	setAttr ".vh" -type "double2" 257.14285714285717 130.95238095238096 ;
	setAttr ".dag" no;
createNode hyperLayout -n "hyperLayout1";
	...
	setAttr ".hyp[3].y" 77.976188659667969;
	setAttr ".hyp[3].nvs" 1920;
	setAttr ".hyp[4].x" 1.1904761791229248;
	setAttr ".hyp[4].y" -0.5952380895614624;
	setAttr ".hyp[4].nvs" 1920;
	setAttr ".hyp[5].x" 1.1904761791229248;
	setAttr ".hyp[5].y" 77.976188659667969;
	setAttr ".hyp[5].nvs" 1920;
	setAttr ".hyp[6].x" 198.33332824707031;
	setAttr ".hyp[6].y" 130.95237731933594;
	setAttr ".hyp[6].nvs" 1920;
	setAttr ".hyp[7].x" 1.1904761791229248;
	setAttr ".hyp[7].y" -0.5952380895614624;
	setAttr ".hyp[7].nvs" 1920;
	setAttr ".hyp[8].x" 1.1904761791229248;
	setAttr ".hyp[8].y" -0.5952380895614624;
	setAttr ".hyp[8].nvs" 1920;
	setAttr ".hyp[9].x" 241.42857360839844;
	setAttr ".hyp[9].y" -72.857139587402344;
	setAttr ".hyp[9].nvs" 1920;
	setAttr ".hyp[10].x" 481.42855834960938;
	setAttr ".hyp[10].y" -72.857139587402344;
	setAttr ".hyp[10].nvs" 1920;
	setAttr ".hyp[11].x" 1.1904761791229248;
	setAttr ".hyp[11].y" -0.5952380895614624;
	setAttr ".hyp[11].nvs" 1920;
	setAttr ".hyp[12].x" 198.33332824707031;
	setAttr ".hyp[12].y" 52.380950927734375;
	setAttr ".hyp[12].nvs" 1920;
	setAttr ".hyp[13].x" 1.1904761791229248;
	setAttr ".hyp[13].y" -0.5952380895614624;
	setAttr ".hyp[13].nvs" 1920;
	setAttr ".hyp[14].x" 1.1904761791229248;
	setAttr ".hyp[14].y" -0.5952380895614624;
	setAttr ".hyp[14].nvs" 1920;
	setAttr ".hyp[15].x" 1.1904761791229248;
	setAttr ".hyp[15].y" -0.5952380895614624;
	setAttr ".hyp[15].nvs" 1920;
	setAttr ".hyp[16].x" 1.1904761791229248;
	setAttr ".hyp[16].y" -0.5952380895614624;
	setAttr ".hyp[16].nvs" 1920;
	setAttr ".hyp[17].x" 1.1904761791229248;
	setAttr ".hyp[17].y" -0.5952380895614624;
	setAttr ".hyp[17].nvs" 1920;
	setAttr ".hyp[18].x" 1.1904761791229248;
	setAttr ".hyp[18].y" -0.5952380895614624;
	setAttr ".hyp[18].nvs" 1920;
	setAttr ".hyp[19].x" 1.1904761791229248;
	setAttr ".hyp[19].y" -0.5952380895614624;
	setAttr ".hyp[19].nvs" 1920;
	setAttr ".hyp[20].x" 592.6190185546875;
	setAttr ".hyp[20].y" 52.380950927734375;
	setAttr ".hyp[20].nvs" 1920;
	setAttr ".hyp[21].x" 395.4761962890625;
	setAttr ".hyp[21].y" 75;
	setAttr ".hyp[21].nvs" 1920;
	setAttr ".hyp[22].x" 1.1904761791229248;
	setAttr ".hyp[22].y" -0.5952380895614624;
	setAttr ".hyp[22].nvs" 1920;
	setAttr ".hyp[23].x" 592.6190185546875;
	setAttr ".hyp[23].y" 130.95237731933594;
	setAttr ".hyp[23].nvs" 1920;
	setAttr ".hyp[24].x" 395.4761962890625;
	setAttr ".hyp[24].y" 75;
	setAttr ".hyp[24].nvs" 1920;
	setAttr ".hyp[25].x" 592.6190185546875;
	setAttr ".hyp[25].y" 52.380950927734375;
	setAttr ".hyp[25].nvs" 1920;
	setAttr ".hyp[26].x" 789.76190185546875;
	setAttr ".hyp[26].y" -60.714286804199219;
	setAttr ".hyp[26].nvs" 1920;
	setAttr ".hyp[27].x" 395.4761962890625;
	setAttr ".hyp[27].y" 3.5714285373687744;
...
createNode polyTweak -n "polyTweak1";
	setAttr ".uopa" yes;
	setAttr -s 3 ".tk";
	setAttr ".tk[40]" -type "float3" 0 -0.70295411 0 ;
...
connectAttr "polyTweak1.msg" "hyperLayout1.hyp[8].dn";
connectAttr "deleteComponent1.msg" "hyperLayout1.hyp[9].dn";
connectAttr "deleteComponent2.msg" "hyperLayout1.hyp[10].dn";
connectAttr "pCylinder2.msg" "hyperLayout1.hyp[11].dn";
connectAttr "pCylinderShape2.msg" "hyperLayout1.hyp[12].dn";
connectAttr "pCylinder3.msg" "hyperLayout1.hyp[13].dn";
connectAttr "pCylinderShape3.msg" "hyperLayout1.hyp[14].dn";
connectAttr "pCylinder4.msg" "hyperLayout1.hyp[15].dn";
connectAttr "pCylinderShape4.msg" "hyperLayout1.hyp[16].dn";
connectAttr "pCylinder5.msg" "hyperLayout1.hyp[17].dn";
connectAttr "pCylinderShape5.msg" "hyperLayout1.hyp[18].dn";
connectAttr "polyUnite1.msg" "hyperLayout1.hyp[19].dn";
connectAttr "pCube2.msg" "hyperLayout1.hyp[20].dn";
connectAttr "pCube2Shape.msg" "hyperLayout1.hyp[21].dn";
connectAttr "transform1.msg" "hyperLayout1.hyp[22].dn";
connectAttr "transform2.msg" "hyperLayout1.hyp[23].dn";
connectAttr "transform3.msg" "hyperLayout1.hyp[24].dn";
connectAttr "transform4.msg" "hyperLayout1.hyp[25].dn";
connectAttr "transform5.msg" "hyperLayout1.hyp[26].dn";
connectAttr "transform6.msg" "hyperLayout1.hyp[27].dn";
